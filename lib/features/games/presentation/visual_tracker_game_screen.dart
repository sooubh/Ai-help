...
class VisualTrackerGameScreen extends StatefulWidget {
  ...
  @override
  State<VisualTrackerGameScreen> createState() => _VisualTrackerGameScreenState();
}

class _VisualTrackerGameScreenState extends State<VisualTrackerGameScreen> with SingleTickerProviderStateMixin {
  ...
  void _showWin() {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        title: Column(
          children: [
            const Icon(Icons.remove_red_eye_rounded, color: AppColors.primary, size: 64)
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  RichText(
                    text: TextSpan(
                      style: const TextStyle(fontSize: 20, color: AppColors.textPrimary, fontFamily: 'Nunito'),
                      children: [
                        const TextSpan(text: 'Catch the ', style: TextStyle(fontWeight: FontWeight.w600)),
                        TextSpan(text: _targetEmoji, style: const TextStyle(fontSize: 32)),
                      ],
                    ),
                  ),
                  Container(
                        ...
                        Align(
                          ...
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                child: Text(_targetEmoji, style: const TextStyle(fontSize: 48)),
                              ),
                            ),
                          ),
                        ),
