    ...
    final faqs = [
      {
        ...
        'a': 'No. CARE-AI provides supplementary guidance and activities. It does not replace professional medical advice, diagnosis, or treatment. Always consult qualified healthcare providers.',
      },
      {
        'q': 'How does the AI personalize responses?',
        'a': 'When you set up your child\'s profile (conditions, communication level, goals), the AI uses this context to tailor every response and activity recommendation.',
      },
      {
        'q': 'Is my data secure?',
        'a': 'Yes. All data is stored securely in Firebase with encryption in transit and at rest. Your data is never shared with third parties. You can export or delete your data anytime from Settings.',
      },
      {
        'q': 'Which conditions does CARE-AI support?',
        'a': 'CARE-AI supports a wide range including Autism (ASD), ADHD, cerebral palsy, Down syndrome, speech delays, sensory processing disorders, and more. Activities are designed to be adaptable.',
      },
      {
        'q': 'Can I use CARE-AI offline?',
        'a': 'Most screens work offline. However, AI Chat requires internet to communicate with the Gemini API. Activities, games, and progress tracking work without connection.',
      },
      {
        'q': 'How do I share reports with my doctor?',
        'a': 'Go to Settings → Generate Doctor Report. This creates a professional summary you can copy and share with your healthcare provider via text, email, or print.',
      },
    ];
