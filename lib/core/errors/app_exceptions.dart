...
class AuthException extends CareAiException {
  const AuthException(String message, {String? code}) : super(message, code: code ?? 'AUTH_ERROR');
}
...
class TimeoutException extends CareAiException {
  const TimeoutException([String message = 'The operation timed out. Please try again.'])
